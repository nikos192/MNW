...
import { ProgramFaq, programFaqQuestions } from "@/components/program-faq";
...
export const metadata: Metadata = {
  title: { absolute: "Custom Forged Wheels Australia | Monza Wheels" },
  description:
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={jsonLd(
          breadcrumbJsonLd([
            { name: "Home", path: "/" },
            { name: "Custom Forged Wheels", path: "/custom-forged-wheels" },
          ]),
        )}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={jsonLd(faqPageJsonLd(programFaqQuestions))}
      />
      <main className={styles.page}>
        <section className={styles.hero}>
          <div className={`${styles.heroInner} container`}>
            <div className={styles.heroCopy}>
              ...
              <h1>Custom forged wheels Australia.</h1>
              <p>
                Found the wheel you want? Send it. Bring us any wheel reference,
                sketch or idea. We turn the direction into a bespoke monoblock
                or two-piece wheel engineered around your exact car.
              </p>
            ...
            <div className={styles.heroVisual}>
              <Image
                ...
                src="/products/MW-11%20%22Serraglio%22%201.png"
              />
            </div>
          </div>
        </section>
        ...
        <section
          ...
          aria-label="MonzaWheels program details"
        >
        ...
        <section className={styles.quoteSection} id="quote">
          <div className={`${styles.quoteGrid} container`}>
            <div className={styles.quoteIntro}>
              ...
              <p>
                Name, email, vehicle make and a reference are enough. Unknown
                technical details can stay blank.
              </p>
              <ul>
                ...
                <li>Custom 3D render and fitment approved before production</li>
              </ul>
            </div>
